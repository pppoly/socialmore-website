...
export const newsItems = [
  {
    ...
    summary: {
      ja: 'コミュニティとの共創をより丁寧に伝えるため、二言語（日本語・英語）サイトを公開しました。',
      en: 'We launched a bilingual (JA/EN) website to share our community work and service updates with more partners.'
    },
    cover: newsCoverWebsite,
    content: {
      ja: [
        'SOCIALMOREの公式サイトが公開されました。トップページではコミュニティ主催者支援や多文化連携の取り組みをコンパクトにまとめ、ブログ形式で最新活動も追えるようになっています。',
        '今後はβテストのレポートや、現場の主催者による記事なども随時追加予定です。引き続き、三鷹を拠点に全国のコミュニティチームと協働していきます。'
      ],
      en: [
        'Our official site is now live. The bilingual experience highlights how we support community organizers and expanding multicultural partnerships, and the News section will act as a running blog for field stories and release notes.',
      ...
      zh: [
        'SOCIALMORE 正式网站上线，我们以日/英双语介绍社群主理人支援、多文化连结等服务，并将新闻区打造成公司博客，持续分享社群实况与版本更新。',
