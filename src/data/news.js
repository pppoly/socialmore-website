export const newsItems = [
  {
    ...
    title: {
      ja: '増資を実施しました',
      en: 'We completed a capital increase',
      zh: '我们已完成增资'
    },
    summary: {
      ja: '派手さはありませんが、会社を安定して継続するために、増資という重要な準備を進めました。',
      en: 'It is not flashy, but we made an important move: a capital increase to strengthen long-term stability.',
      zh: '这不是一件高调的事，但我们完成了一项关键准备：通过增资增强公司的长期稳定性。'
    },
    content: {
      ja: [
        '最近、あまり目立たないけれど、大事なことを一つやりました。増資です。派手な話ではありません。ストーリーにするほどのことでもないのかもしれません。',
        'でも、会社を少しでも安定させるための準備です。スタートアップには不確実さがつきものです。だからこそ、できる準備はしておきたい。',
        'プロダクトを磨き続けること。チームを少しずつ広げていくこと。そのための土台を整えました。',
        '勢いだけでやるつもりはありません。ちゃんと続けるつもりです。もし今、スタートアップに入るか迷っているなら、少なくとも、これは衝動ではありません。'
      ],
      en: [
        'Recently, we did something important that may not stand out: we completed a capital increase. It is not a flashy story, and maybe not the kind of update that draws attention.',
        'But this is preparation to make the company more stable. Startups always carry uncertainty, so we want to do the preparation we can, while we can.',
        'We are building the foundation to keep improving the product and to expand the team step by step.',
        'We are not running only on momentum. We are committed to continuity. If you are considering whether to join a startup now, at least this was not an impulse.'
      ],
      zh: [
        '最近我们做了一件不太显眼、但很重要的事：完成了增资。这并不高调，甚至也许谈不上“故事性”。',
        '但这是为了让公司更稳定而做的准备。创业公司天然伴随不确定性，所以我们希望把能做的准备先做好。',
        '我们在夯实基础，以便持续打磨产品，并一步一步扩展团队。',
        '我们不打算只靠一时的冲劲。我们打算长期做下去。如果你正在犹豫要不要加入一家创业公司，至少这件事不是冲动决定。'
      ]
    }
  },
  {
